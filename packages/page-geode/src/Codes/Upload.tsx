...
import ABI from '../shared/ABI.jsx';
import InputName from '../shared/InputName.jsx';
import MessageSignature from '../shared/MessageSignature.jsx';
import InputMegaGas from '../shared/InputMegaGas.jsx';
import Params from '../shared/Params.jsx';
        ...
        {step === 2 && contractAbi && (
          <>
            ...
            {contractAbi.constructors[constructorIndex].isPayable && (
              <InputBalance
                //help={t('The balance to transfer from the `origin` to the newly created contract.')}
